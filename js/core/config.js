/**
 * @file config.js
 * @description Firebase initialisation. Exports `auth` and `db` singletons
 *              used across the entire application.
 *
 * NOTE: The Firebase web API key is safe to expose in client-side code.
 *       Restrict it to your domain in the Firebase console:
 *       https://console.firebase.google.com → Project Settings → API restrictions
 */
